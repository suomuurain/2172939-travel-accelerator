...
var _toursSwiper = require("./modules/tours-swiper");
var _educationSwiper = require("./modules/education-swiper");
var _reviewsSwiper = require("./modules/reviews-swiper");
var _advantagesSwiper = require("./modules/advantages-swiper");
var _gallerySwiper = require("./modules/gallery-swiper");
var _video = require("./modules/video");
var _phoneMask = require("./modules/phone-mask/phone-mask");
require("./modules/email-mask/email-mask");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _heroSwiper.initHeroSwiper)();
  (0, _video.initVideoSlide)();
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    (0, _phoneMask.initPhoneMask)();
    (0, _toursSwiper.initToursSwiper)();
    (0, _educationSwiper.initEducationSwiper)();
    (0, _reviewsSwiper.initReviewsSwiper)();
    (0, _advantagesSwiper.initAdvantagesSwiper)();
    (0, _gallerySwiper.initGallerySwiper)();
  });
});
...
},{"./modules/advantages-swiper":2,"./modules/education-swiper":3,"./modules/email-mask/email-mask":4,"./modules/form-validate/form":6,"./modules/gallery-swiper":12,"./modules/hero-swiper":13,"./modules/menu":14,"./modules/modals/init-modals":15,"./modules/phone-mask/phone-mask":17,"./modules/reviews-swiper":18,"./modules/tours-swiper":19,"./modules/video":20,"./utils/ios-vh-fix":23}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initAdvantagesSwiper = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var tablet = window.matchMedia('(max-width: 1199px)');
var advantagesSwiper = null;
var setAdvantagesSwiper = function setAdvantagesSwiper() {
  advantagesSwiper = new _swiper.default('.advantages__swiper', {
    loop: true,
    slidesPerView: 'auto',
    initialSlide: 0,
    autoHeight: true,
...
var breakpointSlider = function breakpointSlider() {
  if (tablet.matches && advantagesSwiper) {
    advantagesSwiper.destroy();
  }
};
var initAdvantagesSwiper = exports.initAdvantagesSwiper = function initAdvantagesSwiper() {
  setAdvantagesSwiper();
  breakpointSlider();
  window.addEventListener('resize', breakpointSlider);
};

},{"../vendor/swiper":25}],3:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initEducationSwiper = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var initEducationSwiper = exports.initEducationSwiper = function initEducationSwiper() {
  var educationSwiper = new _swiper.default('.education__swiper', {
    breakpoints: {
      320: {
        slidesPerView: 1,
        initialSlide: 3
...
},{"../vendor/swiper":25}],4:[function(require,module,exports){
"use strict";

var EMAIL_REGEXP = /[a-zA-Zа-яёА-ЯЁ0-9]{1}([a-zA-Zа-яёА-ЯЁ0-9\-_\.]{1,})?@[a-zA-Zа-яёА-ЯЁ0-9\-]{1}([a-zA-Zа-яёА-ЯЁ0-9.\-]{1,})?[a-zA-Zа-яёА-ЯЁ0-9\-]{1}\.[a-zA-Zа-яёА-ЯЁ]{2,6}/;
...
exports.initGallerySwiper = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var initGallerySwiper = exports.initGallerySwiper = function initGallerySwiper() {
  var gallerySwiper = new _swiper.default('.gallery__swiper', {
    loop: true,
    slidesPerView: 'auto',
    slidesPerGroup: 2,
    breakpoints: {
...
},{"../vendor/swiper":25}],13:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initHeroSwiper = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var initHeroSwiper = exports.initHeroSwiper = function initHeroSwiper() {
  var swiperHero = new _swiper.default('.hero__swiper', {
    loop: true,
    slidesPerView: 1,
    pagination: {
...
},{"../vendor/swiper":25}],14:[function(require,module,exports){
"use strict";

var nav = document.querySelector('.navigation__list');
var navToggle = document.querySelector('.header__menu-btn');
...
pageWrapper.addEventListener('click', function (evt) {
...
},{"../../utils/focus-lock":21,"../../utils/scroll-lock":24}],17:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initPhoneMask = void 0;
...
var initPhoneMask = exports.initPhoneMask = function initPhoneMask() {
...
exports.initReviewsSwiper = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var initReviewsSwiper = exports.initReviewsSwiper = function initReviewsSwiper() {
  var reviewsSwiper = new _swiper.default('.reviews__swiper', {
    loop: true,
    autoHeight: true,
    breakpoints: {
      320: {
...
exports.initToursSwiper = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var initToursSwiper = exports.initToursSwiper = function initToursSwiper() {
  var toursSwiper = new _swiper.default('.tours__swiper', {
    initialSlide: 1,
    autoHeight: true,
    breakpoints: {
      320: {
...
},{"../vendor/swiper":25}],20:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initVideoSlide = void 0;
var playButton = document.querySelector('[data-play-button="button"]');
var video = document.querySelector('[data-video="video"]');
var poster = document.querySelector('[data-poster="poster"]');
var swiperPagination = document.querySelector('.hero__swiper-pagination');
...
var initVideoSlide = exports.initVideoSlide = function initVideoSlide() {
  initVideo();
  swiperPagination.addEventListener('click', function (evt) {
